...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.wordList.setMidLineWidth(3)
        ...
        self.wordList.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.wordList.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
        ...
        self.label_wl.setGeometry(QtCore.QRect(30, 20, 141, 20))
